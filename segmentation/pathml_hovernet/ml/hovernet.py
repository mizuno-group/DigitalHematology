...
from pathml_hovernet.ml.utils import center_crop_im_batch, dice_loss, get_sobel_kernels
from pathml_hovernet.utils import segmentation_lines
...
def loss_hovernet(outputs, ground_truth, n_classes=None):
    ...
    true_mask = true_mask.cpu()  # NOTE: update 240418
    true_hv = true_hv.cpu()  # NOTE: update 240418
    ...
    if n_classes is None:
        ...
        np_out = np_out.cpu()  # NOTE: update 240418
        hv = hv.cpu()  # NOTE: update 240418
        nc = nc.cpu()  # NOTE: update 240418
